    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Leonard Kumaro</div>
            <div class="text-sm font-medium leading-none text-gray-400">bkleonard174@gmail.com</div>
          </div>
        </div>
